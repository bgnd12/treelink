...
<div class="grid lg:grid-cols-3 gap-8">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-white rounded-2xl border border-ink-100 p-6 shadow-card">
            ...
            <ul id="links-list" data-reorder-url="{{ route('dashboard.links.reorder') }}" class="space-y-3">
    ...
    <div>
        <div class="sticky top-24">
            ...
            @include('components.phone-preview', ['profile' => $profile, 'links' => $links, 'user' => auth()->user()])
        </div>
    </div>
</div>
@endsection
