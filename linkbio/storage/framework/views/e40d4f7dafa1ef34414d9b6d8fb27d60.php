<?php $__env->startSection('title', ($title ?? 'Autentikasi').' — '.config('app.name')); ?>
...
<div class="min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-brand-600 to-indigo-700 items-center justify-center p-16 overflow-hidden">
        ...
        <div class="relative z-10 text-white max-w-md">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 font-extrabold text-2xl">
    ...
    <div class="flex-1 flex items-center justify-center px-6 py-16 sm:px-10">
        <div class="w-full max-w-md animate-fade-up">
            <div class="lg:hidden mb-8">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 font-extrabold text-xl text-ink-900">
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\treelink\linkbio\resources\views/layouts/auth.blade.php ENDPATH**/ ?>