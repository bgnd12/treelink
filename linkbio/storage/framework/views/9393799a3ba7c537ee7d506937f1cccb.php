    ...
    <div class="max-w-7xl mx-auto px-5 sm:px-8">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div class="col-span-2">
                <a href="<?php echo e(route('home')); ?>" class="flex items-center gap-2 font-extrabold text-lg text-white">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="<?php echo e(route('home')); ?>#features" class="hover:text-white">Fitur</a></li>
                    <li><a href="<?php echo e(route('register')); ?>" class="hover:text-white">Daftar Gratis</a></li>
                    <li><a href="<?php echo e(route('login')); ?>" class="hover:text-white">Masuk</a></li>
                </ul>
            </div>
            <div>
                <p class="text-white font-semibold text-sm mb-3">Perusahaan</p>
                <ul class="space-y-2 text-sm">
                    <li><a href="<?php echo e(route('home')); ?>#faq" class="hover:text-white">FAQ</a></li>
        ...
        <div class="mt-10 pt-6 border-t border-white/10 text-xs text-ink-500 flex flex-col sm:flex-row justify-between gap-2">
            <p>&copy; <?php echo e(date('Y')); ?> TreeLink. Seluruh hak cipta dilindungi.</p>
            <p>Dibuat dengan Laravel &amp; Tailwind CSS.</p>
        </div>
    </div>
</footer>
<?php /**PATH C:\laragon\www\treelink\linkbio\resources\views/components/footer.blade.php ENDPATH**/ ?>